...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, "f:o:d:t:l:i:c:r:m:",
                                   ["input_file=", "output_file=", "depth=", "timelimit=", "lambda=",
                                    "input_sample=",
                                    "calibration=", "restricted_label=", "mode="])
    ...
    if mode == "classification":
        ...
        train_prec = get_prec(master, data_train, b_value, beta_value, p_value, restricted_label)
        test_prec = get_prec(master, data_test, b_value, beta_value, p_value, restricted_label)
        calibration_prec = get_prec(master, data_calibration, b_value, beta_value, p_value, restricted_label)
