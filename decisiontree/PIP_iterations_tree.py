        ...
        if method == 4:
            ...
            for selected_piece in candidate_M_set_index:
                ...
                with open(details_csv, mode='a', newline='') as details:
                    ...
                    writer.writerow([file_path['run'], method_list[method-1], settings['tau_0'], beta_p, file_path['shrinkage_iter'], file_path['piece_index'], iteration, integer_rate/100, counts_result['num_integer_vars'], objective_function_term['objective_value'], objective_function_term['optimality_gap'], 
